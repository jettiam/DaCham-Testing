...
<body>
	...
	<div id="infoWrap">
		<div id="dachamInfoText">
			<h1>만성질환 식단의 문제점</h1>
			<br> 시중에 판매되고 있는 제품만으로는 만성질환의 식단을 완벽하게 해결하기는 매우 어렵습니다.<br>  
			질환식이 아직 대중화되어 있지 않은 우리 사회에서는 질환환자나 질환을 가지고 있는 가정에서 질환식을 준비하기에는<br>
			비용의 문제도 있고 번거로움 또한 만만치 않습니다.<br> 
			그런 고민들을 한번에 해결한 건강하고 편리한 맞춤 질환식을 다참이 준비했습니다.<br>
