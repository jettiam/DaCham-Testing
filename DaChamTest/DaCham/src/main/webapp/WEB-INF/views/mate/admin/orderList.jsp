...
<body>
   ...
   <input type="hidden" name="orderCode" value="${orderCode}">
	...
	<div>
		<a class ="font" onclick="divcall('a1');">전체주문|&nbsp&nbsp</a>
		<a class ="font" onclick="divcall('a2');">|결제 대기 주문|&nbsp&nbsp</a>
		<a class ="font" onclick="divcall('a3');">|결제 완료 주문|&nbsp&nbsp</a>
		<a class ="font" onclick="divcall('a4');">|배송중 주문|&nbsp&nbsp</a>
		<a class ="font" onclick="divcall('a5');">|완료된 주문|&nbsp&nbsp</a>
		<a class ="font" onclick="divcall('a6');">|취소된 주문|&nbsp&nbsp</a>
	</div>
	<div>
